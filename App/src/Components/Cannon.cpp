...
std::weak_ptr<GameObject> Cannon::ResetLoadedBobble()
{
	...
	static std::uniform_int_distribution<int> dist(0, (int)BobbleColor::MAX_COLORS);

	// call 0-8 times randomly
	auto times = dist(rng);
	...
	transform->SetWorldRotation(0.0f);
