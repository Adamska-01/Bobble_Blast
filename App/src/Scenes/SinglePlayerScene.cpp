...
void SinglePlayerScene::Enter()
{
	...
	backgroundObject.lock()->AddComponent<ImageScroller>(AssetPaths::Files::BACKGROUND_IMAGE_PATH, ScrollDirection::VERTICAL, 50.0f);
	backgroundObject.lock()->GetTransform()->Scale(Vector2(0.5f, 0.5f));

	GameObject::Instantiate<GameMap>(AssetPaths::Files::SINGLEPLAYER_MAP_PATH);
